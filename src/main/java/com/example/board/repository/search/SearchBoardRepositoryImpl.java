...
public class SearchBoardRepositoryImpl extends QuerydslRepositorySupport implements SearchBoardRepository {
    ...
    public SearchBoardRepositoryImpl() {
        super(Board.class); //domainClass타입을 parameter로 하는 QuerydslRepositorySupport의 생성자를 이용해 객체 생성
    }
    @Override
    public Board search1() {
        ...
        tuple.groupBy(board, member.email);
    ...
    public Page<Object[]> searchPage(String type, String keyword, Pageable pageable) {
        ...
        return new PageImpl<Object[]>(result.stream().map(t -> t.toArray()).collect(Collectors.toList()),
                pageable, count); //각각의 tuple들을 Array형태로 변환
